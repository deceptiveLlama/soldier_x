var talents = [
    ...
    { 
      ...
      description: "Your melee in stealth will also stab your target with a poison tipped dagger that will deal damage over 5s.",
      comment: "",
      cooldown: 20,
    ...
    { 
      ...
      keybind: '"[Hold: [CTRL]]"',
      description: "Enter stealth when crouching out of combat. Melee from stealth: Short stun and target hit can't heal for 4s.",
    ...
    { 
      ...
      comment: "Must be activated at least 3m above the ground. Damage and knockback is increased the longer you stay in air (up to 1s).",
      cooldown: 20,
      upgrade_information: "[Upgrade: +Damage, +Knockback]",
      cd_reduction_per_rank: 0,
      requires_any_of: [],
      is_unique: false,
      conflicts_with: [],
    ...
    { 
      ...
      keybind: '"[PASSIVE]"',
      description: "Marks low-health targets (also through walls). If you have more health, deal 20% more & receive 20% less damage from them.",
      comment: "",
      cooldown: 0,
      upgrade_information: "[Upgrade: +Health Percentage Threshold]",
      cd_reduction_per_rank: 0,
      requires_any_of: [],
      is_unique: false,
      conflicts_with: [],
    ...
    { 
      ...
      comment: "Heals you over 2s and the heal of the each potion stack.",
      cooldown: 15,
      upgrade_information: "[Upgrade: +Healing]",
      cd_reduction_per_rank: 0,
      requires_any_of: [],
    ...
    { 
      ...
      comment: "The damage is reduced by 50% if you have the talent [Bombardment]",
      cooldown: 0,
      upgrade_information: "[Upgrade: +Damage]",
      cd_reduction_per_rank: 0,
      requires_any_of: [],
    ...
    { 
      ...
      description: "Leap forward, become invisible and invulnerable for 0.5s. You will [vanish] if you have the stealth talent.",
      comment: "Vanish: Will enter stealth if you are in combat, even if Stealth is on cooldown.",
      cooldown: 22.5,
      upgrade_information: "[Upgrade: -Cooldown]",
    ...
    { 
      ...
      keybind: '"[Passive]"',
      description: "Resist a lot of damage while you are reloading, sprinting or stunned.",
      comment: "",
      cooldown: 0,
    ...
    { 
      ...
      keybind: '"[Passive]"',
      description: "Increase your health, knockback & headshot resistance, but slightly increase your size.",
      comment: "",
      cooldown: 0,
      upgrade_information: "[Upgrade: +Health, +Knockback, +Headshot Resist, +Size]",
      cd_reduction_per_rank: 0,
      requires_any_of: [],
      is_unique: true,
      conflicts_with: ["sprinter"],
    ...
    { 
      ...
      keybind: '"[[SHIFT]]"',
      description: "Increase the speed of your sprinting and reduce your size.",
      comment: "",
      cooldown: 0,
      upgrade_information: "[Upgrade: +Speed, -Size]",
      cd_reduction_per_rank: 0,
      requires_any_of: [],
      is_unique: true,
      conflicts_with: ["gigachad", "ignore_pain"],
      expand_mind: null,
    },
  ]
